...
void Game::initWindow()
{
    ...
    this->window = new sf::RenderWindow(this->videomode, "First SFML", sf::Style::Titlebar | sf::Style::Close);
...
void Game::initFonts()
{
    ...
    {
        std::cout << "ERROR::GAME::INITFONTS::Fail to load!" << "\n";
...
void Game::updateEnemies()
{
    if (this->enemies.size() < this->maxEnemies)
    {
        /*
            ...
            Remove the enemies at edge of the screen
        */
